...
Class RmHistory
    ...
    Sub New(ByVal EIF_EventSeries As AdlParser.CComplexObject, ByVal a_filemanager As FileManagerLocal)
...
#Region "ADL and XML Handling"
    ...
    Private Sub ProcessEventSeries(ByVal ObjNode As AdlParser.CComplexObject, ByVal a_filemanager As FileManagerLocal)
        Dim i As Integer
        ...
        For i = 1 To ObjNode.attributes.count
            ...
            Select Case attribute.RmAttributeName.ToCil.ToLower(System.Globalization.CultureInfo.InvariantCulture)
                ...
                Case "items", "events"  'items is OBSOLETE
                    Dim an_Event As AdlParser.CComplexObject
                    Dim ii As Integer
                    ...
                    For ii = 1 To attribute.Children.Count
                        an_Event = attribute.Children.ITh(ii)
                    ...
                    End If
                Case Else
                    MessageBox.Show(AE_Constants.Instance.Incorrect_format & ": illegal attribute - " & attribute.RmAttributeName.ToCil & " in EventSeries", AE_Constants.Instance.MessageBoxCaption, MessageBoxButtons.OK, MessageBoxIcon.Error)
            End Select
        Next
    End Sub
        ...
        Try
            ...
            For Each an_attribute In ObjNode.attributes
                Select Case an_attribute.rm_attribute_name.ToLower(System.Globalization.CultureInfo.InvariantCulture)
                    Case "name", "runtime_label"  'run_time_label is obsolete
                        mRunTimeConstraint = ArchetypeEditor.XML_Classes.XML_RmElement.ProcessText(CType(an_attribute.children(0), AdlParser.CComplexObject))
