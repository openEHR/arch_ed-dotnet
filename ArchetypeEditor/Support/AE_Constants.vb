...
Public Class AE_Constants
    ...
    Protected Sub New(ByVal Language As String)
        ...
        mSpecialisationsToo = TerminologyServer.Instance.RubricForCode(710, Language)
        ...
        mNoEmbeddedArchetypeMatches = TerminologyServer.Instance.RubricForCode(712, Language)
