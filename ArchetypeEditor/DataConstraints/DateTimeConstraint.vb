...
'	description: "Constraint on DateTime values"
...
Class Constraint_DateTime
    ...
    Public Property TypeofDateTimeConstraint() As Integer
        Get
            Return iDTconstraint
        End Get
...
'License.
'
'The Original Code is DateTimeConstraint.vb.
'
