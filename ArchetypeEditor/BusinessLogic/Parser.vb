...
Public Interface Parser
    ...
    ReadOnly Property Archetype() As Archetype
    ReadOnly Property OpenFileError() As Boolean
    ...
    Sub WriteFile(ByVal fileName As String, ByVal parserSynchronised As Boolean)
...
'License.
'
'The Original Code is Parser.vb.
'
