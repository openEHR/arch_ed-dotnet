...
'
'	file:        "$URL: http://www.openehr.org/svn/knowledge_tools_dotnet/TRUNK/ArchetypeEditor/DataConstraintsView/URIViewControl.vb $"
'	revision:    "$LastChangedRevision: 63 $"
'	last_change: "$LastChangedDate: 2007-01-09 21:15:11 +1100 (Tue, 09 Jan 2007) $"
'
'

Option Strict On

Public Class IdentifierViewControl : Inherits ElementViewControl
    ...
    Protected Overrides Sub InitialiseComponent(ByVal aConstraint As Constraint, ByVal aLocation As System.Drawing.Point)
        Dim IdentifierConstraint As Constraint_Identifier = CType(aConstraint, Constraint_Identifier)
        mLoading = True
...
'License.
'
'The Original Code is IdentifierViewControl.vb.
'
