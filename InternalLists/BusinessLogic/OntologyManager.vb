...
Public Class OntologyManager
    ...
    Private Function MakeDefinitionsTable(ByVal nm As String) As DataTable
        ...
        ' Added ListColumnOrder to support temprary correct ordering of internal codelists
        ' to match order in Definition
        ...
        DefinitionsTable.Columns.Add(ListOrderColumn)       ' Return the new DataTable.
