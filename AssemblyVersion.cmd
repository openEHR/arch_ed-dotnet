...
if /i "%1" == "Release" (
	for /f "delims=-; tokens=2" %%R in ('git --git-dir=%~dp0.git describe --match Revision') do (
...
::License.
::
::The Original Code is AssemblyVersion.cmd.
::
::The Initial Developer of the Original Code is
::Sam Heard, Ocean Informatics (www.oceaninformatics.com).
::Portions created by the Initial Developer are Copyright 2007
